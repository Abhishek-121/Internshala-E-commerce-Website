...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-2">
         <img align="right" src="images/contact_us.jpg" alt="contact us">
        </div>
    </div>
        ...
        <div class="col-sm-3">
	       <div class="contact-info">
	           <h2 class="title">Contact Info</h2>
	               <address>
				    <p>500 Lokesh Nagar,</p>
				    <p>22/10 New building, Delhi</p>
				    <p>India</p>
	            ...
	            <div><h2 class="title">Follow Us On&#58;</h2>
                   <a href="http://www.facebook.com/estore" target="_blank"><img src="images/6.jpg" alt="fb logo" style="width:30px; height:30px; border:0"></a>
                   <a href="http://www.twitter.com/estore" target="_blank"><img src="images/4.jpg" alt="twitter logo" style="width:30px; height:30px; border:0 padding-left:10px;"></a>
               </div>
            </div>
        </div>
    </div>
